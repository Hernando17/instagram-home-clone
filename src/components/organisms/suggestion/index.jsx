        ...
        <div className="suggestion">
            <div className="suggestion-container">
                <div className="suggestion-user">
                    <div className="suggestion-data">
                        ...
                        <div className="suggestion-detail">
                            ...
                            <span className="suggestion-name" style={{ color: colors.gray, fontSize: 14 }}>{user.fullname}</span>
                        </div>
                    </div>
                    <span className="suggestion-action">Switch</span>
                </div>
                <div className="suggestion-for-you">
                    <span style={{ color: colors.gray, fontSize: 14 }}>Suggestions for you</span>
                            ...
                            <div className="suggestion-user" key={index}>
                                <div className="suggestion-data">
                                    ...
                                    <div className="suggestion-detail">
                                        ...
                                        <span style={{ color: colors.gray, fontSize: 12 }} className="suggestion-name" >
                                            {
                ...
                <div className="suggestion-info">
                    <span style={{ color: colors.lightGray, fontSize: 12 }}><a href="#">About</a> · <a href="#">Help</a> · <a href="#">Press</a> · <a href="#">API</a> · <a href="#">Jobs</a> · <a href="#">Privacy</a> · <a href="#">Terms</a> · <a href="#">Locations</a> · <a href="#">Language</a></span>
                </div>
                <span style={{ marginTop: 24, color: colors.lightGray, fontSize: 12 }}>© 2023 INSTAGRAM FROM META</span>
            </div>
